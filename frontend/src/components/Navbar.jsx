        ...
        {menuOpen && (
          ...
          >
            ...
            <motion.aside
              ...
              className="relative w-72 max-w-[80vw] h-full border-l border-[#c2995a]/40 shadow-[0_0_28px_rgba(194,153,90,0.35)] p-6 flex flex-col overflow-y-auto bg-gradient-to-b from-[#101010] via-[#0a0a0a] to-[#000000]"
              role="dialog"
              aria-modal="true"
